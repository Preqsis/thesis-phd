...
%% TODO
%% Muj Cygnus X-1 pro demonstraci
...
%% TODO
%% obrazek GRBu??? -> spis neni potreba
...
Another important parameter of the CV binary system is its size, which is closely related to individual component masses and determines the accretion disk size because the gravitational potential constrains the disk's outer edge. The outer disk radius is calculated

%% TODO
%% mozna podrobnejsi vyjadreni jak se dojde ke vztahu??
