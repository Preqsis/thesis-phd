...
\section{Mass-spring model (MSM)} 
    ...
    On the basis of \eqref{eq:msm_original_odes} \citep{msmm1999} proposed a improved version of MSM, that is expresed by following set of ODE's
