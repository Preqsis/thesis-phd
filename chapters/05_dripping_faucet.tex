...
\section{Drop equilibrum states}
    ...
    Figure \ref{fig:plot_drop_equilibrium_ceiling} shows multiple equilibrum states solutions for diferrent values of pressure $P_{\mathrm{b}}$ at the bottom of the drop.
