...
\begin{document}
    ...
    \input{./chapters/mdh-model_proposal.tex}
    ...
    \newpage
    \phantomsection
    \addcontentsline{toc}{chapter}{LIST OF ABBVERBATIONS}
    \noindent \Large \textbf{LIST OF ABBVERBATIONS}
    \normalsize
    \input{./chapters/abbverbations.tex}
