...
\begin{document}
    ...
    \input{./chapters/03_cataclysmic_variables.tex}

    % 4. FLICKERING PHENOMENON
    \input{./chapters/04_flickering_phenomenon.tex}
    ...
    \input{./chapters/08_mdh_model.tex}
    
    % 9. MDH - THERMAL PROCESSES
    \input{./chapters/09_mdh_thermal_processes.tex}

    % 10. MDH - SYNTHETIC LIGHT CURVES
    \input{./chapters/10_mdh_synthetic_light_curves.tex}

    % 11. MODELLING TECHNIQUES AND IMPLEMENTATION 
    \input{./chapters/11_modeling_techniques_and_implementation.tex}

    % 12. CV - MODEL
    \input{./chapters/12_cv_models.tex}

    % 13. ALPHA MODEL FITING
    \input{./chapters/13_alpha_model_fiting.tex}
