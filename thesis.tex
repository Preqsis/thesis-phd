...
\begin{document}
    ...
    % Kapitoly
    % --
    %\abovedisplayskip 0.5cm plus 0cm minus 0cm
	%\abovedisplayshortskip 0.0cm plus 0cm minus 0cm
	%\belowdisplayskip=0.6cm plus 0cm minus 0cm
	%\belowdisplayshortskip=0.6cm plus 0cm minus 0cm
